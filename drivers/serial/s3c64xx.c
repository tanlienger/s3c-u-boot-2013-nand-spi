...
//	uart->UBRDIV = pclk / baudrate / 16 - 1;/*********my add+++++++*/
//	uart->UDIVSLOT = udivslot[i];		/*********my add+++++++*/
...
static int s3c64xx_serial_init(void)
{
	...
	uart->UFCON = 0xff;	/*********my add+++++++*/
	uart->UMCON = 0;	/*********my add+++++++*/
	/* 8N1 */
//	uart->ULCON = 3;	/*********my add+++++++*/
	uart->ULCON = 0<<6|0<<3|0<<2|0b11;
	/* No interrupts, no DMA, pure polling */
//	uart->UCON = 5;		/*********my add+++++++*/
	uart->UCON = 0b10<<10|0<<9|0<<8|0<<7|0<<6|0<<5|0<<4|1<<2|1;
	serial_setbrg();
