...
print_address(CONFIG_SYS_NAND_U_BOOT_OFFS);
print_address(CONFIG_SYS_NAND_U_BOOT_SIZE);
print_address(CONFIG_SYS_NAND_U_BOOT_DST);
...
print_address(CONFIG_ENV_OFFSET);
print_address(CONFIG_ENV_SIZE);
print_address(CONFIG_NAND_ENV_DST);
