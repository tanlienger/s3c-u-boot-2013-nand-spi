...
#define CONFIG_DM9000_BASE				0x50000300
...
//#define CONFIG_SYS_PHY_UBOOT_BASE	(CONFIG_SYS_SDRAM_BASE + 0x07000000)
...
#define CONFIG_SYS_NAND_U_BOOT_SIZE	((252+22) * 1024)	/* Size of RAM U-Boot image   */
